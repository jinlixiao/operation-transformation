  ...
  test "eventual consistency III" do
    ...
    client =
      spawn(:client, fn ->
        ...
        OT.Client.delete(client_c, 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_a, 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "e", 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_a, "f", 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_b, "g", 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_a, 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_a, "h", 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_b, "i", 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "j", 3, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "k", 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_c, 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_a, 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "l", 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_a, "m", 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_b, "n", 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_a, 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_a, "o", 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_b, "p", 2, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "q", 3, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "r", 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_c, 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_a, 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "s", 4, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_a, "t", 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_b, "u", 3, Map.new(view, fn x -> {x, 0} end))
        OT.Client.delete(client_a, 1, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_a, "a", 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_b, "b", 0, Map.new(view, fn x -> {x, 0} end))
        OT.Client.insert(client_c, "c", 0, Map.new(view, fn x -> {x, 0} end))
